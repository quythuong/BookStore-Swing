...
public class panel_iReceipt extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cb_publisherId.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cb_publisherIdActionPerformed(evt);
            }
        });
        jPanel3.add(cb_publisherId, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 20, 210, 40));
    ...
    private void tf_dateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_tf_dateActionPerformed
        ...
        private void lbl_saveBtnMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbl_saveBtnMouseClicked
            ...
            if (tf_iReceiptId.getText().isEmpty() || cb_publisherId.getSelectedItem() == null || tf_date.getText().isEmpty()) {
                JOptionPane.showMessageDialog(this, "Không được để trống các trường!");
                return;
            }
            try {

                IReceiptModel iReceipt = new IReceiptModel(tf_iReceiptId.getText(), cb_publisherId.getSelectedItem().toString(), new java.sql.Date(formatter.parse(tf_date.getText()).getTime()));
    ...
    private void cb_publisherIdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cb_publisherIdActionPerformed

    }//GEN-LAST:event_cb_publisherIdActionPerformed
    ...
    private void loadPublisher() {
        ...
        try {
            List<PublisherModel> list = publisherDao.getAll();
            for (PublisherModel publisher : list) {
