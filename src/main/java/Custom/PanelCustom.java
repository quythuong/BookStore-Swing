...
public class PanelCustom extends JPanel{
    ...
    public int getRoundTopRigt() {
        return roundTopRight;
    }

    public void setRoundTopRigt(int roundTopRigt) {
        this.roundTopRight= roundTopRigt;
    }
    ...
    public int getRoundBottomRigt() {
        return roundBottomRight;
    }

    public void setRoundBottomRigt(int roundBottomRigt) {
        this.roundBottomRight = roundBottomRigt;
    }
